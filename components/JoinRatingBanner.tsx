...
export function JoinRatingBanner() {
  ...
  return (
    <Link
      href="/rating"
      className="animate-blur-fade-up liquid-glass fixed inset-x-4 z-30 mx-auto flex max-w-sm items-center justify-center gap-2 rounded-full px-5 py-3 text-sm font-medium shadow-2xl sm:inset-x-auto sm:left-1/2 sm:-translate-x-1/2"
